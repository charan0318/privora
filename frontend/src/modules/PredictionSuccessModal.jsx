...
const PredictionSuccessModal = ({ isOpen, onClose, transactionHash, positionAmount, positionOption }) => {
            ...
            >
              ...
              >
                ...
                <p className="text-gray-400 text-sm">
                  Your encrypted allocation has been confirmed on-chain
                </p>
              </motion.div>
                ...
                <div className="rounded-2xl bg-gradient-to-br from-gray-800/80 to-gray-900/80 p-5 border border-gray-700/50 backdrop-blur-sm">
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-white font-bold text-lg">{positionAmount} USDC</span>
                    </div>
                    <div className="h-px bg-gradient-to-r from-transparent via-gray-700 to-transparent"></div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-400 text-sm">Your Choice</span>
                      <span className="text-white font-semibold">{positionOption}</span>
                    </div>
                    <div className="h-px bg-gradient-to-r from-transparent via-gray-700 to-transparent"></div>
                    <div className="flex justify-between items-center">
                      ...
                      <span className="inline-flex items-center gap-2 text-green-400 font-medium text-sm">
                        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 5 0 016 0z" clipRule="evenodd" />
                        </svg>
                        Fully Encrypted
                      </span>
                    </div>
